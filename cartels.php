...
<div class="container mt-3 rounded">
        ...
        <tbody class="table-danger">
                <?php
                    while($row=mysqli_fetch_assoc($result)) {
                        ?>
                        <tr>
                        <td><?php echo $row['cartelID'] ?></td>
                        <td><?php echo $row['cartelName'] ?></td>
                        <td><?php echo $row['stateAbbr'] ?></td>
    ...
    <div class="divText">Note: Names of sample cartels are not actual cartels.</div>
</div>
...
<div class="container-md p-2 my-3 bg-light text-black rounded">
        ...
        <a href="#" class="btn bg-success text-light">Search for a Record</a>
        </div><br><br>

        <div class="btn-group center3">
        <a href="#" class="btn bg-danger text-light <?php echo $enable1; ?>">Add a Record</a>
        </div><br><br>

        <div class="btn-group center3">
        <a href="#" class="btn bg-primary text-light <?php echo $enable2; ?>">Delete a Record</a>
        </div>
</div>
